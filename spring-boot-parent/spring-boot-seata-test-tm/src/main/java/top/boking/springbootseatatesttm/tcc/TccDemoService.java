package top.boking.springbootseatatesttm.tcc;
...
public class TccDemoService {
    ...
    public void insert(@BusinessActionContextParameter(paramName = "params") Map<String, Object> params) {
        log.info("此处可以预留资源,或者利用tcc的特点,与AT混用,二阶段时利用一阶段在此处存放的消息,通过二阶段发出,比如redis,mq等操作");
    }
